...
-- -----------------------------------------------------
-- Table `miScore`.`Equipo`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `miScore`.`Equipo` (
...
-- -----------------------------------------------------
-- Table `miScore`.`Torneo`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `miScore`.`Torneo` (
...
-- -----------------------------------------------------
-- Table `miScore`.`Torneo_has_Equipo`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `miScore`.`Torneo_has_Equipo` (
  ...
  CONSTRAINT `fk_Torneo_has_Equipo_Torneo`
    ...
    REFERENCES `miScore`.`Torneo` (`idTorneo` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Torneo_has_Equipo_Equipo1`
    FOREIGN KEY (`Equipo_idEquipo` )
    REFERENCES `miScore`.`Equipo` (`idEquipo` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
